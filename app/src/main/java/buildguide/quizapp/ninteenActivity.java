...
public class ninteenActivity extends AppCompatActivity {
    Button butplayagain;
    Button butnewgame;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        butplayagain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(ninteenActivity.this,MainActivity.class);
        ...
        butnewgame.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ninteenActivity.this,fourthActivity.class);
                startActivity(intent);
